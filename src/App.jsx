...
import CorrectButton from './UIComponents/CorrectButton.jsx';
import WrongButton from './UIComponents/WrongButton.jsx';
import ShowAnswerButton from './UIComponents/ShowAnswerButton.jsx';
import PlayerCard from './UIComponents/PlayerCard.jsx';
...
import ManualButton from './UIComponents/ManualButton.jsx';
import Credits from './UIComponents/Credits.jsx';
import GenericGameMode from './UIComponents/GenericGameMode.jsx';
import './App.css';
...
function App() {
  ...
  const [gamePhase, setGamePhase] = useState('flip-card');
  ...
  const handleCardClick = () => {
    ...
    if (gamePhase === 'flip-card' && !isCardFlipped) {
              ...
              <div className="center-column">
                ...
                <div className="game-buttons-column">
                  ...
                  <CorrectButton
                    ...
                    disabled={allQuestionsCompleted || !isCardFlipped || gamePhase !== 'answer-question' || !activePlayerId}
                  />
                  <ShowAnswerButton
                    onClick={handleShowAnswer}
                    width={getButtonDimensions().width}
                    height={getButtonDimensions().height}
                    disabled={allQuestionsCompleted || !isCardFlipped || showAnswer || gamePhase !== 'answer-question' || !activePlayerId}
                  />
                  <WrongButton
              ...
              <div className="right-side">
                <div className="game-instructions">
                  {allQuestionsCompleted ? (
                    ...
                    <>
                      {gamePhase === 'flip-card' && !isGameWon && (
                        <p>Haz clic en la carta para revelar la pregunta</p>
                      )}
                      {gamePhase === 'flip-card' && isGameWon && (
                        <p>Haz clic en la carta para ver la pregunta</p>
                      )}
